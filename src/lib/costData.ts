...
export const costSources: Record<string, CostSource> = {
  ...
  casamigaPrices: { name: "Casamiga Weddings: prices and packages (2027 price list)", url: "https://www.casamiga-weddings.com/prices-and-packages", year: 2026 },
...
export const costItems: CostItem[] = [
  ...
  // Private chef
  { id: "private-chef", categorySlug: "private-chef", service: "Private chef at home", unit: "per guest", low: 45, high: 105, typical: 80, note: "Group size matters most: about €85 a guest for two people, around €59 for three to six and about €45 for a dozen or more on one platform. Guests actually book menus averaging about €78 to €85 a person, and premium chefs cost much more. Ingredients, service and cleaning are usually included.", ask: ["Are ingredients, service and cleaning included?", "Is there a minimum spend?"], sources: ["takeachef", "cozymeal"], confidence: "limited" },
  ...
  // Wedding planner
  { id: "wedding-planner", categorySlug: "wedding-planner", service: "Full wedding planning", unit: "planner fee, often plus 21% VAT", low: 3000, high: 8000, note: "Planner's fee only, not the cost of the wedding. English-speaking destination planners in Barcelona commonly start around €4,000 to €4,500 plus VAT, and generic Spain-wide guides that quote €2,000 to €5,000 understate this for international couples. Some planners charge 10 to 15 per cent of the budget instead, and custom productions can exceed €10,000. A Barcelona wedding typically costs €35,000 or more in total.", ask: ["Is the price before or after 21% VAT?", "Flat fee or percentage of budget?", "What is included: venue search, vendors, design, day-of?"], sources: ["casamigaPrices", "agapeDestination", "mynatural"], confidence: "good" },
  { id: "wedding-planner-partial", categorySlug: "wedding-planner", service: "Partial wedding planning", unit: "planner fee, often plus 21% VAT", low: 2000, high: 4000, note: "For couples who have already booked a venue or some vendors. One Barcelona destination planner lists partial planning from €3,450 plus VAT, and a 2025 destination guide puts partial or coordination-only services at €2,000 to €4,000.", ask: ["Which parts does the planner manage?", "Is VAT included?"], sources: ["casamigaPrices", "agapeDestination"], confidence: "limited" },
  { id: "wedding-day-coordination", categorySlug: "wedding-planner", service: "Wedding day coordination", unit: "planner fee, often plus 21% VAT", low: 1000, high: 2500, note: "Someone to run the day itself. A premium Barcelona destination planner lists it from €2,000 plus VAT for a single venue and single day, with higher fees in peak months, while generic national guides quote about €600 to €1,800.", ask: ["How many hours and coordinators are included?", "Are peak-month surcharges applied?"], sources: ["casamigaPrices", "weddingsHelp"], confidence: "limited" },
  ...
  { id: "naturopath-consult", categorySlug: "naturopath", service: "Naturopath consultation", unit: "follow-up to first consultation", low: 80, high: 130, note: "One Barcelona naturopath publishes €130 for a two-hour first consultation, €80 for a one-hour follow-up or child consultation and €350 for a six-month programme. Other practices may price differently, and tests such as food intolerance panels are usually extra.", ask: ["How long is the first consultation?", "Are tests or supplements charged separately?"], sources: ["naudin"], confidence: "limited" },
];
