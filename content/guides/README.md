...
8b. **Refresh llms.txt:** run `node scripts/make-llms.mjs` so AI systems see the new guides, and include `public/llms.txt` in the commit (add `git add public/llms.txt`).
